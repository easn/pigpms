...
if (!empty($now_store)) {
    ...
    $tmp_store = D('Store')->field('store_id,drp_supplier_id,uid,open_drp_limit,drp_limit_buy,drp_limit_share,drp_limit_condition')->where(array('store_id' => $_GET['id']))->find();
