	...
	<div class="activi_header_content">
		...
		<div class="activi_header_content_right">
			...
			<div class="content_list_img activi_header_bottom">
				<a href="javascript:;" class="recommend check_activity" data-q-start-time="<?php echo $recommend['qcode_starttime']?>" data-id="<?php echo $recommend['id'];?>">
				<img src="<?php echo $recommend['image'];?>">
				<div class="content_list_erweima">
					<div class="content_list_erweima_img "><img class="code_img" height="159" srcs="<?php echo $recommend['qcode']?>"  srcs1="./source/qrcode.php?type=activity&id=no&url=<?php echo $recommend['appurl'];?>"></div>
				</div>
				</a>
			</div>
		</div>
	...
	<div class="content_commodity content_activity hot_activity"  >
		...
		<div class="content_list_activity cur">
			<ul class="content_list_ul">
				...
				<li class="check_activity" data-q-start-time="<?php echo $value['qcode_starttime']?>" data-id="<?php echo $value['id'];?>"> 
