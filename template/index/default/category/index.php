...
<div class="content category">
	...
	<style>
		...
		.cata_table .li_img, .cata_table dl dd .nxz {
			background: rgba(0, 0, 0, 0) url("<?php echo TPL_URL;?>images/ico/list_03.png") repeat scroll 0 0;
			float: left;
			height: 14px;
			margin-left: 3px;
			margin-top: 18px;
		...
		.cata_table .asc .li_img, .cata_table dl dd  .xz_asc {
			background: rgba(0, 0, 0, 0) url("<?php echo TPL_URL;?>images/ico/list_04_h.png") repeat scroll 0 0;
			float: left;
			height: 14px;
			margin-left: 3px;
			margin-top: 18px;
		...
		.cata_table .desc .li_img, .cata_table dl dd  .xz_desc {
			background: rgba(0, 0, 0, 0) url("<?php echo TPL_URL;?>images/ico/list_03_h.png") repeat scroll 0 0;
			float: left;
			height: 14px;
			margin-left: 3px;
			margin-top: 18px;
