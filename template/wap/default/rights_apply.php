						...
						<div class="block block-form">
							...
							<div class="block-item " style="padding:5px 0; font-weight:bold;">
								<ul>
									...
									<li style="clear:both; height:24px; line-height:24px;">
										<span style="float:left; padding:0px; color:#CCC;">订单金额：</span>
										<span style="float:right; padding:0px; color:#666;">￥<?php echo $order['sub_total'] ? $order['sub_total'] : $order['total'] ?></span>
									</li>
									<li style="clear:both; height:24px; line-height:24px;">
