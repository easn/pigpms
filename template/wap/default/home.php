...
<html class="no-js admin <?php if($_GET['ps']<=320){echo ' responsive-320';}elseif($_GET['ps']>=540){echo ' responsive-540';} if($_GET['ps']>540){echo ' responsive-800';} ?>" lang="zh-CN">
	<head>
		...
		<?php } ?>
		<script type="text/javascript">var storeId=<?php echo $now_store['store_id'];?>,is_logistics = <?php echo $now_store['open_logistics'] ? 'true' : 'false' ?>,is_selffetch = <?php echo $now_store['buyer_selffetch'] ? 'true' : 'false' ?></script>
