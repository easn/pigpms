...
<div class="tabber tabber-n2 tabber-double-11 clearfix"> <a <?php if($_GET['action']=='goods'||empty($_GET['action'])){?>class="active"<?php } ?> href="./my_shoucang.php?action=goods">商品</a> <a <?php if($_GET['action']=='store'){?>class="active"<?php } ?> href="./my_shoucang.php?action=store">店铺</a></div>
<?php }else{?>
<div class="tabber tabber-n2 tabber-double-11 clearfix"> <a class="active" href="./my_shoucang.php?action=goods&store_id=<?php echo $_GET['store_id']?>" style="width:100%">商品</a> </div>
<?php } ?>
