            ...
            <div id="dataArea">
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <th style="text-align: left">关注时间</th>
...
<tbody>
					...
					<tr>
                        <td style="text-align: left"><?php echo $user_list[$v['uid']]['nickname']; ?></td>
                        <td style="text-align: left"><?php echo date('Y-m-d H:i:s',$v['subscribe_time']);?></td>
