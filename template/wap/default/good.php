...
<head>
	...
	<script src="<?php echo TPL_URL;?>js/sku.js?time=<?php echo time();?>"></script>
	<script src="<?php echo TPL_URL;?>js/good.js?time=<?php echo time();?>"></script>
...
$('.goods_guanzhu').click(function(){
	var url = "collect.php?action=attention&id=" + <?php echo $_GET['id']+0; ?> + "&type=1&store_id="+<?php echo $_GET['store_id']?>;
...
$('.goods_shoucang').click(function(){
	var url = "collect.php?action=add&id=" + <?php echo $_GET['id']+0; ?> + "&type=1&store_id="+<?php echo $_GET['store_id']?>;
	var number = parseInt($(this).find("span").html());
	$.get(url,function(data){
		motify.log(data.msg);
		if(data.status){
