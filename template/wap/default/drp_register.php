...
<head>
    ...
    <script type="text/javascript">
        ...
        var open_drp_diy_store = parseInt('<?php echo $open_drp_diy_store; ?>');
    </script>
    <style type="text/css">
        .motify {
            text-align: center;
...
<script type="text/javascript">
    ...
    $("#nextBtn").click(function () {
        ...
        if (tempid == "settitle") {
            ...
            $.post('./drp_store.php', {'store_id': '<?php echo $_GET['id']?>', "name": title, "pids": '', "truename": name, "tel": phone, 'qq': qq, 'type': 'add', 'open_drp_approve': open_drp_approve, 'open_drp_diy_store': open_drp_diy_store}, function(data){
                //return false;
                if(data.err_code == 0) {
