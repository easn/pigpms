...
<head>
	...
	<title>退货管理 - <?php echo $store['name']; ?></title>
	...
	<script type="text/javascript">
		...
		function FillData(_pagenum, _pagesize) {
			$.get("./drp_return.php", {'a': 'list', 'p': _pagenum, 'pagesize': _pagesize}, function (data) {
				if (data != '') {
...
<div class="tabs-content" id="wrapper" style="top:40px;">
	<div id="scroller" class="content active">
			...
			<table width="100%">
				<thead>
					<tr>
						...
						<!-- <th class="left">退货类型</th> -->
						<th style="width:25%">退货状态</th>
						<th style="text-align: center; width:33%">退货时间</th>
		...
		<div class="nocontent-tip" id="ordernull" style="">
			...
			<p class="nocontent-tip-text">你还没有退货</p>
		</div>
