...
<head>
    ...
    <style type="text/css">
        .product .image {
            height: 300px;
            width: auto;
            background-image: url(<?php echo $nowProduct['image']; ?>);background-repeat: no-repeat;filter:"progid:DXImageTransform.Microsoft.AlphaImageLoader(sizingMethod='scale')";-moz-background-size:100% 100%;background-size:100% 100%;
        }
    </style>
</head>
            ...
            <div class="talk">
                <ul>
                    ...
                    <li style="font-weight: bold; width: 90%" class="popover right">
                        <div class="arrow"></div>
                        <p class="msg">我是分销商 <span style="color: #FF9900;font-weight: bold"><?php echo $nowStore['name']; ?></span>，<br/>我为 <span style="color: #FF9900;font-weight: bold"><?php echo $store['name']; ?></span> 分销</p>
                    </li>
                </ul>
                <div class="clear"></div>
            </div>
        ...
        <div class="product">
            <div class="image">
                <div class="name">
                    ...
                    <span class="price">￥<?php echo $nowProduct['price']; ?></span>
                    <?php if (!empty($nowProduct['original_price'])) { ?>&nbsp;&nbsp;&nbsp;<span class="original-price">￥<?php echo $nowProduct['original_price']; ?><?php } ?></span></div>
            </div>
            <div class="qrcode">
