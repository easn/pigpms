...
<head>
	...
	<link rel="stylesheet" href="<?php echo $config['site_url'];?>/static/css/fancybox.css"/>
	<script src="<?php echo $config['site_url'];?>/static/js/jquery.min.js"></script>
	<script src="<?php echo $config['site_url'];?>/static/js/jquery.fancybox-1.3.1.pack.js"></script>
	<style type="text/css">
		tr {
