		<script type="text/javascript">var wap_home_url="<?php echo $config['wap_site_url'];?>/home.php?id=<?php echo $store_session['store_id']?>",wap_ucenter_url="<?php echo $config['wap_site_url'];?>/ucenter.php?id=<?php echo $store_session['store_id']?>",upload_url="<?php echo $config['site_url'];?>/upload/",store_name="<?php echo $store_session['name']?>",store_logo="<?php echo $store_session['logo'];?>";</script>
		...
		<script type="text/javascript" src="<?php echo TPL_URL;?>js/customField.js?time=<?php echo time();?>"></script>
