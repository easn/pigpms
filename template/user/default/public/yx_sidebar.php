	...
	<nav>
		...
		<ul>
			...
			<li <?php if(in_array($select_sidebar,array('coupon','statistics'))) echo 'class="active"';?>>
				<a href="<?php dourl('preferential:coupon');?>">优惠券<?php echo $my_version;?></a>
			</li>
			<?php if(!in_array($my_version,array('1','2','5','6'))){?>
			...
			?>
			<li class="testFunc <?php if(in_array($select_sidebar,array('unitary'))) echo 'active';?>">
				<a href="<?php dourl('unitary:index');?>">一元夺宝</a>
			</li>
		</ul>
		<h4>营销功能</h4>
		<ul>
