			...
			<aside class="ui-sidebar sidebar" style="min-height: 843px;">
	            <nav>
					<ul>
						...
						<?php if(($weixin_bind_info['service_type_info'] != 2 && $weixin_bind_info['verify_type_info'] == '0') || ($weixin_bind_info['service_type_info'] == 2 && $weixin_bind_info['verify_type_info'] == '0')){?>
