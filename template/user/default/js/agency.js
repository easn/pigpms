...
$(function(){
    ...
    $('.js-search-btn').live('click', function(){
        ...
        load_page('.app__content', load_url, {page:'agency_content', 'keyword': keyword}, '', function(){
    ...
    $('.pagenavi > a').live('click', function(e){
        ...
        var keyword = $.trim($('.js-search').val());
        $('.app__content').load(load_url, {page: 'agency_content', 'p': p, 'keyword': keyword}, function(){
            if (keyword != '') {
                $('.js-search').val(keyword);
            }
        });
