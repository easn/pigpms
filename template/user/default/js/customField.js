...
var customField={
	list:function(){
		...
		if(typeof(is_sync_user) == 'undefined' || is_sync_user == '0' || is_sync_user == '') {
			return [{type:"rich_text",val:"富文本"},{type:"image_ad",val:"图片<br/>广告"},{type:"goods",val:"商品"},{type:"title",val:"标题"},{type:"text_nav",val:"文本<br/>导航"},{type:"image_nav",val:"图片<br/>导航"},{type:"link",val:"关联<br/>链接"},{type:"search",val:"商品<br/>搜索"},{type:"line",val:"辅助线"},{type:"white",val:"辅助<br/>空白"},{type:"component",val:"自定义<br/>模块"},{type:"store",val:"进入<br/>店铺"},{type:"notice",val:"公告"},{type:"goods_group1",val:"餐饮小食1"},{type:"goods_group2",val:"餐饮小食2"},{type:"coupons",val:"优惠券"},
				...
				{type:"tpl_shop1",val:"网店logo抬头1"},{type:"attention_collect",val:"店铺关注和收藏"}
			];	
		}else {	
	...
	clickEvent:function(dom){
		...
		clickArr['tpl_shop'] = function(){
			...
			//defaultHtml = '<div class="tpl-shop"><div class="tpl-shop-header" style="background-images:url(/upload/images/head_bg1.png);background-color:#6DABEB"><div class="tpl-shop-title">'+biaotis+'</div><div class="tpl-shop-avatar"><img src="/upload/images/default_shop.png" alt=""></div></div><div class="tpl-shop-content"><ul class="clearfix"><li><a href="javascript:;"><span class="count">0</span> <span class="text">全部商品</span></a></li><li><a href="javascript:;"><span class="count">0</span> <span class="text">关注我的</span></a></li><li><a href="javascript:;"><span class="count user"></span> <span class="text">我的订单</span></a></li></ul></div></div>';
			var logos = "";
