...
$(function(){
    ...
    load_page('.app__content', load_url, {page: page_content, 'status': tmp_status, 'start_time': start_time, 'stop_time': stop_time,'nickname':nickname}, '', function(){
        if (start_time) {
	...
	function location_page(mark,dom){
		...
		switch(mark_arr[0]){
			...
			case "#edit":
				...
				break;
			default:
				load_page('.app__content', load_url,{page:'fans_list',p:1}, '');
		}
	}
