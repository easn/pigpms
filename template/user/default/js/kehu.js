	...
	$(".js-btn-add-save").live('click',function(){
		...
		switch(location_type) {
			...
			case 'tag':
				...
				$.post(load_url, {"page" : page_create, "is_postage_free":is_postage_free, "level_pic":level_pic, "discount":discount, "level_num":level_num, "rule_name" : rule_name, "rule_type" : rule_type,"description" : description, "trade_limit" : trade_limit, "amount_limit" : amount_limit, "points_limit" : points_limit, "is_submit" : "submit"}, function (data) {
	...
	$(".js-btn-edit-save").live('click',function(){
		...
		switch(location_type) {
			...
			case 'tag':
				...
				$.post(load_url, {"page" : page_edit,"id":id, "is_postage_free":is_postage_free,"level_pic":level_pic, "discount":discount, "level_num":level_num, "rule_name" : rule_name, "rule_type" : rule_type,"description" : description,  "trade_limit" : trade_limit, "amount_limit" : amount_limit, "points_limit" : points_limit, "is_submit" : "submit"}, function (data) {
