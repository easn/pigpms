...
function create_sku(){
	...
	switch(sku_dom_count){
		...
		case 1:
			...
			html += '<thead><tr><th class="text-center">'+(sku_arr[current_i].siblings('h3').find('span.select2-chosen').html())+'</th><th class="th-price text-right">价格（元）</th><th class="th-stock text-right">库存</th><th class="th-stock text-right">重量(克)</th><th class="th-code">商家编码</th><th class="text-right">销量</th></tr></thead>';
			html += '<tbody>';
		...
		case 2:
			...
			html += '<thead><tr><th class="text-center">'+(sku_arr[current_i1].siblings('h3').find('span.select2-chosen').html())+'</th><th class="text-center">'+(sku_arr[current_i2].siblings('h3').find('span.select2-chosen').html())+'</th><th class="th-price text-right">价格（元）</th><th class="th-stock text-right">库存</th><th class="th-stock text-right">重量(克)</th><th class="th-code">商家编码</th><th class="text-right">销量</th></tr></thead>';
			html += '<tbody>';
			...
			break;
		case 3:
			html += '<thead><tr><th class="text-center">'+(sku_arr[0].siblings('h3').find('span.select2-chosen').html())+'</th><th class="text-center">'+(sku_arr[1].siblings('h3').find('span.select2-chosen').html())+'</th><th class="text-center">'+(sku_arr[2].siblings('h3').find('span.select2-chosen').html())+'</th><th class="th-price text-right">价格（元）</th><th class="th-stock text-right">库存</th><th class="th-stock text-right">重量(克)</th><th class="th-code">商家编码</th><th class="text-right">销量</th></tr></thead>';
			html += '<tbody>';
