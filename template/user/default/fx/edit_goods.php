...
<head>
    <meta charset="utf-8"/>
    <title>分销商品修改编辑- <?php echo $store_session['name'];?> | <?php if (empty($_SESSION['sync_store'])) { ?><?php echo $config['site_name'];?><?php } else { ?>微店系统<?php } ?></title>
    ...
    <script type="text/javascript">
        var load_url="<?php dourl('load');?>", product_id = "<?php echo $_GET['id']; ?>", edit_fx_url="<?php echo dourl('edit_goods'); ?>",edit_setting_url="<?php echo dourl('fx:supplier_market'); ?>";</script>
