...
<html>
	<head>
		...
		<script type="text/javascript">var is_sync_user = "<?php echo $_SESSION['sync_store'];?>";var load_url="<?php dourl('case_load');?>", create_page_url="<?php dourl('create_page'); ?>", index_page_url="<?php echo dourl('page'); ?>";</script>
