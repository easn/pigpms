...
<html>
	<head>
		...
		<script type="text/javascript">var is_sync_user = "<?php echo $_SESSION['sync_store'];?>";var load_url="<?php dourl('case_load');?>", open_ad_url="<?php dourl('open_ad'); ?>", save_ad_url="<?php dourl('save_ad'); ?>", action="<?php echo $action; ?>";</script>
