...
<div class="wrap_1000 clearfix container">
    ...
    <div class="app" style="float:<?php echo $store_session['drp_level'] > 0 ? 'none' : '';?>">
            ...
            <div class="app-init-container">
                <div class="ui-nav dianpu">
                    <ul>
						...
						<li class="js-app-nav notice_list testFunc">
							<a href="#notice_list">消息/通知管理</a>
						</li>						
					</ul>
                </div>
