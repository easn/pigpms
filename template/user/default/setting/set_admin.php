...
<head>
    ...
    <script type="text/javascript">var load_url="<?php dourl('load');?>", store_name_check_url = "<?php dourl('store_name_check'); ?>",store_setting_url="<?php dourl('store'); ?>",store_contact_url="<?php dourl('contact'); ?>",add_admin="<?php dourl('add_admin'); ?>",store_admin_edit="<?php dourl('store_edit'); ?>",store_admin_del="<?php dourl('store_admin_del'); ?>",static_url="<?php echo TPL_URL;?>",change_select="<?php dourl('change_unique');?>",uid="<?php echo $_GET['uid'];?>";</script>
    <script type="text/javascript" src="<?php echo TPL_URL;?>js/setting_admin.js"></script>
