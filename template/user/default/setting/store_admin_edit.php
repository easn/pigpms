...
<form class="form-horizontal" style="">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <label class="checkbox inline">
                <input  type="checkbox" class="js-not-autoup" name="goods[]" <?php echo in_array('checkoutProduct', $methodList['goods']) ? 'checked' : '';?> value="get_qrcode_activity">导出商品
            </label>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <label class="checkbox inline">
                <input type="checkbox" class="js-not-autoup" name="order[]" <?php echo in_array('order_download_csv', $methodList['order']) ? 'checked' : '';?> value="check">导出订单
            </label>			
        </div>
        <?php }else{ ?>
         <div class="controls">
            ...
            <label class="checkbox inline">
                <input type="checkbox" class="js-not-autoup" name="order[]" value="order_download_csv">导出订单
            </label>			
        </div>
