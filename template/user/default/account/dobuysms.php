...
<head>
	...
	<script type="text/javascript" src="<?php echo TPL_URL; ?>js/account_dobuysms.js?time=<?php echo time();?>"></script>
<style>
.block-help>a {
	...
	<form class="form-horizontal">
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					<img width="200" height="200"  src="<?php echo $config['site_url'];?>/static/images/blank.gif"class="qrcode_img">
				</div>
