...
<html>
	<head>
		...
		<script type="text/javascript">var is_sync_user = "<?php echo $_SESSION['sync_store'];?>";var update_storelogo_url="<?php dourl('update_store_logo'); ?>",load_url="<?php dourl('load');?>",add_url="<?php dourl('wei_page_category_add');?>",wap_cat_url="<?php echo $config['wap_site_url'];?>/pagecat.php",edit_url="<?php dourl('wei_page_category_edit');?>",delete_url="<?php dourl('wei_page_category_delete');?>";</script>
